...
1. <tt>rake uvi:setup</tt> to create a migration.
...
===Renaming Underlying Tables
  ...
  execute "UPDATE uvi SET child_aggregate_view = 'new_name' WHERE child_aggregate_view = 'old_name'"
  execute "UPDATE uvi SET parent_relation = 'new_name' WHERE parent_relation = 'old_name'"
...
Run <tt>rake uvi:fixture</tt> to generate fixture for the uvi table. <b>Without it primary key sequence for 
